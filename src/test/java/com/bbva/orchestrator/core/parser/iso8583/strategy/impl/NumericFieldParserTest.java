...
class NumericFieldParserTest {
    ...
    @InjectMocks
    private NumericFieldParser numericFieldParser;
    ...
    void parse_success_returnsParsedResult() {
        ...
        // Act
        ParsedFieldResult result = numericFieldParser.parse(rawDataSegment, fieldDefinition, networkHandlerField);
    ...
    void parse_runtimeException_throwsParserLocalException() {
        ...
        assertThrows(ParserFieldsException.class, () -> {
            numericFieldParser.parse(rawDataSegment, fieldDefinition, networkHandlerField);
    ...
    void build_success_returnsEncodedString() {
        // Arrange
        String processedDataSegment = "12345678";
        String encodedValue = "3132333435363738";
        when(networkHandlerField.encode(anyString(), any())).thenReturn(encodedValue);

        // Act
        String result = numericFieldParser.build(processedDataSegment, fieldDefinition, networkHandlerField);
