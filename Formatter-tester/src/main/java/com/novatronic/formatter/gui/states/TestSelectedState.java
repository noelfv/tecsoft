 ...
 * @author Omar
 */
public class TestSelectedState extends State{
    private static final Logger log = Logger.getLogger(TestSelectedState.class);
    ...
    public void execute() {
        ...
        log.debug("Estado TestSelectedState ejecutado");
    }
