 ...
 * @author Omar
 */
public class SaveFrameResultAction extends Action<JButton> implements ActionListener {

    private static final Logger log = Logger.getLogger(SaveFrameResultAction.class);
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        log.debug("Guardando datos de Trama Generada...");
        String fileName = "[FRAME.RESULT]" + actualTest.getId() + "." 
                + actualTest.getFormatId() + "-" + DATE_FORMAT.format(new Date())
                + ".txt";
        if (FileUtil.SaveFrame(fileName, actualTest.getFrameGenerated())) {
